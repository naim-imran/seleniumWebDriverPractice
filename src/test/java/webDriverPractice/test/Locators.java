...
public class Locators {
	...
	public void setupInitialComponents() {
		threadSafeDriver = new ThreadSafeDriver();
		/*
		 * InitialComponents initialComponents = new InitialComponents(); driver =
		 * initialComponents.launchBrowser();
		 */
	...
	public void relativeLocator_above() {
		 ...
		 */
		driver.findElement(
				with(By.xpath("//span[@id='gh-ug']")).above(driver.findElement(By.xpath("//a[@id='gh-la']")))).click();
	}
